...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: pguser
--
...
ALTER TABLE public.employees OWNER TO pguser;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: pguser
--
